...
describe WorkerPlugins::RemoveQuery do
  ...
  let(:result) { WorkerPlugins::RemoveQuery.execute!(query: Task.all, workplace: workplace) }
  let(:service) { WorkerPlugins::RemoveQuery.new(query: Task.all, workplace: workplace) }
